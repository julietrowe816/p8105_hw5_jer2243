...
on x axis. Make a second plot of avg estimate of mu_hat only in samples
for which the null was rejected on the y axis and true value of mu on x
axis.
...
<img src="p8105_hw5_jer2243_files/figure-gfm/unnamed-chunk-7-1.png" width="90%" />
The resulting plot shows the association between the true mu value on
the x-axis and the average estimate of mu-hat on the y-axis. The blue
line shows those values in the cases where the null value was rejected,
and the black line shows all cases. At smaller effect sizes, the average
estimate of mu does not do a great job of approximating the true mu
value, but at larger values, the red line converges onto the black line,
showing that as effect size increases, the estimate of mu does a better
job at estimating the true mu.
